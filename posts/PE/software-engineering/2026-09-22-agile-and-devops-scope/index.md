...
- **DevOps** — **ISO/IEC/IEEE 32675:2022**(IEEE Std 2675-2021을 패스트트랙으로 채택)
  가 근거다. 용어 정의 절(§3.1)이 내린 정의를 옮기면 이렇다.
...
DevOps의 배경은 다른 자리에 있다. 32675의 DevOps 개요 절(§5.1)은 **빌드·패키지·배포를 완전 자동화하는
...
32675의 DevOps 원칙 절(§5.2)이 원칙 **4가지**를 든다.
...
조직 문화 절(§5.3)은 문화를 **5개 항목**으로 나눈다. 리더십 / 조직 구조와 역학 / 효과적
...
> retirement"로 적고, 같은 문서의 생애주기 절(§5.4)이 DevOps를 각 단계에 동등한 비중을 두는
...
2. **DevOps는 애자일을 전제로 하지 않는다.** 32675의 생애주기 절(§5.4)은 DevOps가 대부분의 생애주기
