...
| 작업 | 시각 | 편수 |
|---|---|---|
| `tech-blog-daily` | 07:00 · 19:00 · 23:00 | 회차당 3편 |
| `tech-blog-exam` | 02:00 · 15:00 | 회차당 단답형 2편 또는 논술형 1편 |
| `tech-blog-concept` | 04:00 · 17:00 | 회차당 2편 |

**하루 총 19편.** 오전 9시에 확인하는 시점에서는 **어제 15·17·19·23시**와
**오늘 2·4·7시** 회차가 모두 끝나 있어야 한다. 일곱 회차다.
...
| `tech-blog-daily` 마지막 실행이 **13시간** 넘게 없음 | **문제.** 회차를 건너뛰었다고 보고 |
...
**문제가 없으면 한 줄로 끝낸다.** 예: `정상 — 어제 15·17·19·23시와 오늘 2·4·7시 회차 모두 완료, 19편, lint 통과, 푸시됨`
