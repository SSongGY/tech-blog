...
description: 어제 15·17·19시와 오늘 7시 회차가 정상이었는지 매일 오전 9시에 한 번 점검한다
---
...
| 작업 | 시각 | 편수 |
|---|---|---|
| `tech-blog-daily` | 07:00 · 19:00 | 회차당 3편 |
| `tech-blog-exam` | 15:00 | 단답형 2편 또는 논술형 1편 |
| `tech-blog-concept` | 17:00 | 2편 |

**하루 총 9~10편.** 오전 9시에 확인하는 시점에서는 **어제 15시·17시·19시**와
...
**문제가 없으면 한 줄로 끝낸다.** 예: `정상 — 어제 15·17·19시와 오늘 7시 회차 모두 완료, 10편, lint 통과, 푸시됨`
